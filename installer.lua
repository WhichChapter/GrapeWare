return (function(hi) 
	...
	for i,v in next, corescripts do 
		registerStep('Downloading vape/'..v, function()
			local res = game:HttpGet('https://raw.githubusercontent.com/WhichChapter/GrapeWare/main/System/'..v)
    ...
    task.spawn(function()
        local res = game:HttpGet('https://api.github.com/repos/WhichChapter/GrapeWare/contents/data/Profiles')
        if res ~= '404: Not Found' then 
    ...
    for i,v in next, guiprofiles do 
        registerStep('Downloading vape/Profiles/'..v, function()
            ...
            --    return 
            --end
            local res = game:HttpGet('https://raw.githubusercontent.com/WhichChapter/GrapeWare/main/data/Profiles/'..v)
			task.wait()
            if res ~= '404: Not Found' then 
...
for i,v in next, libraryfiles do 
    registerStep('Downloading vape/Libraries/'..v, function()
        local res = game:HttpGet('https://raw.githubusercontent.com/WhichChapter/GrapeWare/main/Libraries/'..v)
        if res ~= '404: Not Found' then 
...
local filesfetched2
task.spawn(function()
    local res = game:HttpGet('https://api.github.com/repos/WhichChapter/GrapeWare/contents/VoidwareFolderFiles')
    if res ~= '404: Not Found' then 
        for i,v in next, httpservice:JSONDecode(res) do 
            if type(v) == 'table' and v.name then 
...
for i,v in next, voidwarefiles do 
    registerStep('Downloading vape/Voidware/'..v, function()
        local res = game:HttpGet('https://raw.githubusercontent.com/WhichChapter/GrapeWare/main/VoidwareFolderFiles/'..v)
        if res ~= '404: Not Found' then 
...
local filesfetched3
task.spawn(function()
    local res = game:HttpGet('https://api.github.com/repos/WhichChapter/GrapeWare/contents/VoidwareFolderFiles/Libraries')
    if res ~= '404: Not Found' then 
        for i,v in next, httpservice:JSONDecode(res) do 
            if type(v) == 'table' and v.name then 
...
for i,v in next, voidwarelibrariesfiles do 
    registerStep('Downloading vape/Voidware/Libraries'..v, function()
        local res = game:HttpGet('https://raw.githubusercontent.com/WhichChapter/GrapeWare/main/VoidwareFolderFiles/Libraries'..v)
        if res ~= '404: Not Found' then 
...
local filesfetched4
task.spawn(function()
    local res = game:HttpGet('https://api.github.com/repos/WhichChapter/GrapeWare/contents/VoidwareFolderFiles/data')
    if res ~= '404: Not Found' then 
        for i,v in next, httpservice:JSONDecode(res) do 
            if type(v) == 'table' and v.name then 
...
for i,v in next, voidwaredatafiles do 
    registerStep('Downloading vape/Voidware/data'..v, function()
        local res = game:HttpGet('https://raw.githubusercontent.com/WhichChapter/GrapeWare/main/VoidwareFolderFiles/data'..v)
        if res ~= '404: Not Found' then 
...
local filesfetched5
task.spawn(function()
    local res = game:HttpGet('https://api.github.com/repos/WhichChapter/GrapeWare/contents/VoidwareFolderFiles/oldvape')
    if res ~= '404: Not Found' then 
        for i,v in next, httpservice:JSONDecode(res) do 
            if type(v) == 'table' and v.name then 
...
for i,v in next, voidwareoldvapefiles do 
    registerStep('Downloading vape/Voidware/oldvape'..v, function()
        local res = game:HttpGet('https://raw.githubusercontent.com/WhichChapter/GrapeWare/main/VoidwareFolderFiles/oldvape'..v)
        if res ~= '404: Not Found' then 
...
local filesfetched6
task.spawn(function()
    local res = game:HttpGet('https://api.github.com/repos/WhichChapter/GrapeWare/contents/VoidwareFolderFiles/System')
    if res ~= '404: Not Found' then 
        for i,v in next, httpservice:JSONDecode(res) do 
            if type(v) == 'table' and v.name then 
...
for i,v in next, voidwaresystemfiles do 
    registerStep('Downloading vape/Voidware/System'..v, function()
        local res = game:HttpGet('https://raw.githubusercontent.com/WhichChapter/GrapeWare/main/VoidwareFolderFiles/System'..v)
        if res ~= '404: Not Found' then 
